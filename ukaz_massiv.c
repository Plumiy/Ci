...
//     int n = sizeof(array)/sizeof(array[0]);         // число строк (размер массива в байта / на размер 1 элемнта в байта)
//     int m = sizeof(array[0])/sizeof(array[0][0]);   // число столбцов (размер 1 эллмента / размер элемента внутри 1-го элемента)
